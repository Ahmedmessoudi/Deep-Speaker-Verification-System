# 📂 Gestion de la Mémoire et Passage à l'Échelle

Ce document décrit les choix d'ingénierie logicielle implémentés dans nos notebooks PyTorch pour permettre un entraînement stable à grande échelle (1 111 locuteurs, 44 Go de données brutes) sous des contraintes matérielles strictes de RAM et de VRAM (Kaggle GPU P100/T4).
...
*   **Total de données brutes** : **44 Go** de données audio sous forme de fichiers `.wav` et `.flac`.
